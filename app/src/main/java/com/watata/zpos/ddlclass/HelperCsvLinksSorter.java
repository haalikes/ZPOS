...
public class HelperCsvLinksSorter {

    String csv_link_id, csv_link_name, z_link_item_id, z_link_var_hdr_id, z_link_var_dtls_id, csv_link_source;

    public HelperCsvLinksSorter() {
    }

    public HelperCsvLinksSorter(String csv_link_id, String csv_link_name, String z_link_item_id, String csv_link_source) {
    ...
    public HelperCsvLinksSorter(String csv_link_id, String csv_link_name, String z_link_item_id, String z_link_var_hdr_id, String z_link_var_dtls_id, String csv_link_source) {
        this.csv_link_id = csv_link_id;
        this.csv_link_name = csv_link_name;
        this.z_link_item_id = z_link_item_id;
